...
class BuildingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post buildings_url, params: { building: { name: @building.name, user_id: @building.user_id } }
    end
  ...
  test "should update building" do
    patch building_url(@building), params: { building: { name: @building.name, user_id: @building.user_id } }
